...
extends SkipListMemtable        // to test framework
{
    ...
    {
        // TODO: implement
        return super.partitionIterator(columnFilter, dataRange, SSTableReadsListener.NOOP_LISTENER);
    }
    ...
    public boolean shouldSwitch(ColumnFamilyStore.FlushReason reason)
    {
        ...
        case VALIDATION: // Called to flush data for repair. TODO: How do we repair?
